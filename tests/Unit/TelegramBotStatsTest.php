...
class FakeHttpClientStats implements ClientContract
{
    ...
    {
        return '000:FAKE_TOKEN_STATS______________________________';
    }
...
it('reports health and stats', function () {
    $bot = new Bot(new FakeHttpClientStats(), ['name' => 't']);
