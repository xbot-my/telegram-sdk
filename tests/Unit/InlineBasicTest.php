...
class FakeHttpClientInline implements ClientContract
{
    ...
    {
        return '000:FAKE_TOKEN_INLINE_________________________________';
    }
...
it('answers callback and inline queries', function () {
    $bot = new Bot(new FakeHttpClientInline(), ['name' => 't']);
