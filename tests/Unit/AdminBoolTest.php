...
class FakeHttpClientAdmin implements ClientContract
{
    ...
    {
        return '000:FAKE_TOKEN_ADMIN________________________________';
    }
...
it('admin core operations return booleans', function () {
    $bot = new Bot(new FakeHttpClientAdmin(), ['name' => 't']);
