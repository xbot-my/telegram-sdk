...
class ValidatingHttpClient implements ClientContract
{
    ...
    {
        return '000:FAKE_TOKEN_VALIDATE____________________________';
    }
...
class ValidatingGroup extends BaseEndpoint
{
    ...
    public function callValidateRequired( array $params, array $required ): void
    {
        $this->validateRequired($params, $required);
    }
    
    public function callValidateText( string $text, int $max = 4096 ): void
    {
        $this->validateTextLength($text, $max);
    }
    
    public function callValidateUrl( string $url, bool $https = false ): void
    {
        $this->validateUrl($url, $https);
    }
    
    public function callValidateCoords( float $lat, float $lng ): void
    {
