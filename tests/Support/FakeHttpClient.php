...
class FakeHttpClient implements HttpClientInterface
{
    ...
    public function setTimeout(int $timeout): static { $this->config['timeout'] = $timeout; return $this; }
    public function setRetryAttempts(int $attempts): static { $this->config['retry_attempts'] = $attempts; return $this; }
    public function setRetryDelay(int $delay): static { $this->config['retry_delay'] = $delay; return $this; }
